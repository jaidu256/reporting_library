select
	...
	,(isnull(pb.[Revenue PY], 0) + isnull(byn.[Revenue PY], 0)) as 'Revenue PY'
	...
	,(isnull(pb.[Spread PY], 0) + isnull(byn.[Spread PY], 0)) as 'Spread PY'
	...
	,(isnull(pb.[Volume PY], 0) + isnull(byn.[Volume PY], 0)) as 'Volume PY'
