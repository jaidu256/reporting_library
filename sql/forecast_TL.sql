...
(
				...
				full outer join bi_prod.afnapp.calendar_dates as cal on cal.calendar_date = m.actual_pickup_arrival_dt_id
...
(
				...
				full outer join bi_prod.afnapp.calendar_dates as cal on cal.calendar_date = b.actual_pickup_date

				where
					rel_cal_month = @s
				and b.service_code = 'TL'
